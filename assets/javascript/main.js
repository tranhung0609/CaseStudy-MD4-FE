const optionAllSongList = document.querySelector.bind(document)('.option-all__songs-list');
const musicNowTym = document.querySelector.bind(document)('.music-control__left-action-tym-box');
const volumeIcon = document.querySelector.bind(document)('.music-control__right-volume-icon');
const audio = document.querySelector.bind(document)('#audio');
// var sliderItems=Array.from(document.querySelectorAll.bind(document)('.option-all__song-slider-img'));
const sliderBox = document.querySelector.bind(document)('.option-all__song-slider');
const sliderItems = document.querySelectorAll.bind(document)('.option-all__song-slider-img');
const playBtn = document.querySelector.bind(document)('.js__music-control__icon-play');
const thunbPlayerBox = document.querySelector.bind(document)('.music-control__left');
const progress = document.querySelector.bind(document)('#progress');
const remainTime = document.querySelector.bind(document)('.js__music-control__progress-time-start');
const durationTime = document.querySelector.bind(document)('.js__music-control__progress-time-duration');
const prevBtn = document.querySelector.bind(document)('.js__music-control__icon2');
const nextBtn = document.querySelector.bind(document)('.js__music-control__icon4');
const nameSong = document.querySelector.bind(document)('.music-control__left-content-song');
const nameSinger = document.querySelector.bind(document)('.music-control__left-content-singer');
const cdThumb = document.querySelector.bind(document)('.music-control__left-img');
const playAllBtn = document.querySelector.bind(document)('.js__playall-0');
const playAllBtn1 = document.querySelector.bind(document)('.js__playall-1');
const randomBtn = document.querySelector.bind(document)('.js__music-control__icon1');
const repeatBtn = document.querySelector.bind(document)('.js__music-control__icon5');
const volumeProgress = document.querySelector.bind(document)('#progress1');
const nextSongHeadding = document.querySelector.bind(document)('.nextsong__fist');
const nextSongList = document.querySelector.bind(document)('.nextsong__last-list');
const header = document.querySelector.bind(document)('.header');
const mainContainer = document.querySelector.bind(document)('.main-container');
const headerSetting = document.querySelector.bind(document)('.header__setting');
const headerOverlay = document.querySelector.bind(document)('.header__right-overlay');
const headerSettingList = document.querySelector.bind(document)('.header__setting-list');

const themeModal = document.querySelector.bind(document)('.theme-modal');
const themebtn = document.querySelector.bind(document)('.header__theme');
const themeClosebtn = document.querySelector.bind(document)('.theme-modal__close-btn');
const themeOverlay = document.querySelector.bind(document)('.theme-modal__overlay');
const themeBody = document.querySelector.bind(document)('.theme-modal__body');
const themeItems = document.querySelectorAll.bind(document)('.js-theme-item');

const loginModal = document.querySelector.bind(document)('.login-modal');
const loginbtn = document.querySelector.bind(document)('.header__setting-item-login');
const loginClosebtn = document.querySelector.bind(document)('.login-modal__close-btn');
const loginOverlay = document.querySelector.bind(document)('.login-modal__overlay');
const loginBody = document.querySelector.bind(document)('.login-modal__body');
...
const registerOverlay = document.querySelector.bind(document)('.register-modal__overlay');
...
const containerPanes = document.querySelectorAll.bind(document)('.js__container-panes');
const slidersDiscover = document.querySelectorAll.bind(document)('.container-discover__slider-item');
...
const app = {
    ...
    toastSlide: function() {
        const toatMain = document.querySelector.bind(document)('#toast');
        if (toatMain) {
    ...
    applyTheme: function() {
        themeItems.forEach((themeItem, index) => {
            themeItem.onclick = function() {
                if (index == 0) {
                    backgroundIndex = 0;
                    document.querySelector.bind(document)('.header').style.backgroundColor = `var(--header-color-${backgroundIndex})`;
                    document.querySelector.bind(document)('.header').style.boxShadow = '0 3px 5px rgba(0,0,0,0.1)';
                    document.querySelector.bind(document)('.header').style.backgroundColor = `var(--header-color-${backgroundIndex})`;
                    document.querySelector.bind(document)('.header').style.boxShadow = '0 3px 5px rgba(0,0,0,0.1)';
                    document.querySelector.bind(document)('.main').style.backgroundImage = 'url(./assets/img/background-theme/backroundThemes/0.svg)';
                    document.querySelector.bind(document)('.main-music-control').style.backgroundImage = '';
                    document.querySelector.bind(document)('.main-music-control').style.backgroundColor = '#37075D';
                    document.querySelector.bind(document)('.mobile-tab').style.backgroundColor = '#37075D';
                    document.querySelector.bind(document)('.sidebar__add-playlist').style.backgroundColor = '#411465';
                    document.querySelector.bind(document)('.sidebar__add-playlist').style.borderTop = '1px solid rgba(255, 255, 255, 0.1)';
                    document.querySelector.bind(document)('.nextsong__option-wrapper').style.backgroundColor = '#4B206E';
                    document.querySelector.bind(document)('.header__width-search-sub').style.backgroundColor = '#6A39AF';
                    document.querySelector.bind(document)('.header__width-search-sub').classList.add('header__width-search-sub--purple');
                    document.querySelector.bind(document)('.header__width-search-sub').classList.remove('header__width-search-sub--white');
                    document.querySelector.bind(document)('.header__width-search-sub').classList.remove('header__width-search-sub--green');
                    document.querySelector.bind(document)('.header__width-search-sub').classList.remove('header__width-search-sub--gray');
                    document.querySelector.bind(document)('.header__width-search').classList.remove('js__gray-backgroundColor');
                    document.querySelector.bind(document)('.header__setting-list').style.backgroundColor = '#6A39AF';
                    document.querySelector.bind(document)('.theme-modal__body').style.backgroundColor = '#6A39AF';
                    document.querySelector.bind(document)('.nextsong__option-wrapper-listplay').style.backgroundColor = '#816399';
                    document.querySelector.bind(document)('.main-sidebar').style.backgroundColor = 'hsla(0,0%,100%,0.05)';
                    document.querySelector.bind(document)('.header__width-search-input').classList.remove('header__width-search-input--white');
                    document.querySelector.bind(document)('.header__width-search-input').classList.add('header__width-search-input--dark');
                    document.querySelector.bind(document)('.music__option-item.music__option-item--active').style.backgroundColor = "#816399";
                    document.querySelector.bind(document)('.music__option-item.music__option-item--active').style.color = "#fff";
                    document.querySelector.bind(document)('.music-control__volume-input').style.backgroundColor = "rgba(255, 255, 255, 0.3)";
                    document.querySelector.bind(document)('.music-control__progress-input').style.backgroundColor = "rgba(255, 255, 255, 0.3)";

                    document.querySelectorAll.bind(document)('.js__main-color').forEach((item) => {
                        item.style.color = '#fff';
                    })
                    document.querySelectorAll.bind(document)('.js__sub-color').forEach((item) => {
                        item.style.color = 'rgba(255, 255, 255, 0.5)';
                    })
                    document.querySelectorAll.bind(document)('.js__backgroundColor').forEach((item) => {
                        item.style.backgroundColor = "rgba(255, 255, 255, 0.1)";
                    })
                    document.querySelectorAll.bind(document)('.js__border').forEach((item) => {
                    ...
                    document.querySelector.bind(document)('.header').style.backgroundColor = `var(--header-color-${backgroundIndex})`;
                    document.querySelector.bind(document)('.header').style.boxShadow = '0 3px 5px rgba(0,0,0,0.1)';
                    document.querySelector.bind(document)('.main').style.backgroundImage = 'url(./assets/img/background-theme/backroundThemes/1.jpg)';
                    document.querySelector.bind(document)('.main-music-control').style.backgroundImage = 'none';
                    document.querySelector.bind(document)('.main-music-control').style.backgroundColor = '#202020';
                    document.querySelector.bind(document)('.mobile-tab').style.backgroundColor = '#202020';
                    document.querySelector.bind(document)('.sidebar__add-playlist').style.backgroundColor = '#333333';
                    document.querySelector.bind(document)('.sidebar__add-playlist').style.borderTop = '1px solid rgba(0, 0, 0, 0.1)';
                    document.querySelector.bind(document)('.nextsong__option-wrapper').style.backgroundColor = '#3E3E3E';
                    document.querySelector.bind(document)('.header__width-search-sub').style.backgroundColor = '#3E3E3E';
                    document.querySelector.bind(document)('.header__width-search-sub').classList.add('header__width-search-sub--gray');
                    document.querySelector.bind(document)('.header__width-search-sub').classList.remove('header__width-search-sub--purple');
                    document.querySelector.bind(document)('.header__width-search-sub').classList.remove('header__width-search-sub--white');
                    document.querySelector.bind(document)('.header__width-search-sub').classList.remove('header__width-search-sub--green');
                    document.querySelector.bind(document)('.header__width-search').classList.remove('js__gray-backgroundColor');
                    document.querySelector.bind(document)('.header__setting-list').style.backgroundColor = '#3E3E3E';
                    document.querySelector.bind(document)('.theme-modal__body').style.backgroundColor = '#3D3D3D';
                    document.querySelector.bind(document)('.nextsong__option-wrapper-listplay').style.backgroundColor = '#787878';
                    document.querySelector.bind(document)('.main-sidebar').style.backgroundColor = 'hsla(0,0%,100%,0.05)';
                    document.querySelector.bind(document)('.header__width-search-input').classList.remove('header__width-search-input--white');
                    document.querySelector.bind(document)('.header__width-search-input').classList.add('header__width-search-input--dark');
                    document.querySelector.bind(document)('.music__option-item.music__option-item--active').style.backgroundColor = "#787878";
                    document.querySelector.bind(document)('.music__option-item.music__option-item--active').style.color = "#fff";
                    document.querySelector.bind(document)('.music-control__volume-input').style.backgroundColor = "rgba(255, 255, 255, 0.3)";
                    document.querySelector.bind(document)('.music-control__progress-input').style.backgroundColor = "rgba(255, 255, 255, 0.3)";
                    ...
                    document.querySelector.bind(document)('.header').style.backgroundColor = `var(--header-color-${backgroundIndex})`;
                    document.querySelector.bind(document)('.header').style.boxShadow = '0 3px 5px rgba(0,0,0,0.1)';
                    document.querySelector.bind(document)('.main').style.backgroundImage = 'url(./assets/img/background-theme/backroundThemes/2.jpg)';
                    document.querySelector.bind(document)('.main-music-control').style.backgroundImage = 'none';
                    document.querySelector.bind(document)('.main-music-control').style.backgroundColor = '#051740';
                    document.querySelector.bind(document)('.mobile-tab').style.backgroundColor = '#051740';
                    document.querySelector.bind(document)('.sidebar__add-playlist').style.backgroundColor = '#132958';
                    document.querySelector.bind(document)('.sidebar__add-playlist').style.borderTop = '1px solid rgba(0, 0, 0, 0.1)';
                    document.querySelector.bind(document)('.nextsong__option-wrapper').style.backgroundColor = '#1F3461';
                    document.querySelector.bind(document)('.header__width-search-sub').style.backgroundColor = '#1F3461';
                    document.querySelector.bind(document)('.header__width-search-sub').classList.add('header__width-search-sub--green');
                    document.querySelector.bind(document)('.header__width-search-sub').classList.remove('header__width-search-sub--purple');
                    document.querySelector.bind(document)('.header__width-search-sub').classList.remove('header__width-search-sub--white');
                    document.querySelector.bind(document)('.header__width-search-sub').classList.remove('header__width-search-sub--gray');
                    document.querySelector.bind(document)('.header__width-search').classList.remove('js__gray-backgroundColor');
                    document.querySelector.bind(document)('.header__setting-list').style.backgroundColor = '#1F3461';
                    document.querySelector.bind(document)('.theme-modal__body').style.backgroundColor = '#192F60';
                    document.querySelector.bind(document)('.nextsong__option-wrapper-listplay').style.backgroundColor = '#637191';
                    document.querySelector.bind(document)('.main-sidebar').style.backgroundColor = 'hsla(0,0%,100%,0.05)';
                    document.querySelector.bind(document)('.header__width-search-input').classList.remove('header__width-search-input--white');
                    document.querySelector.bind(document)('.header__width-search-input').classList.add('header__width-search-input--dark');
                    document.querySelector.bind(document)('.music__option-item.music__option-item--active').style.backgroundColor = "#637191";
                    document.querySelector.bind(document)('.music__option-item.music__option-item--active').style.color = "#fff";
                    document.querySelector.bind(document)('.music-control__volume-input').style.backgroundColor = "rgba(255, 255, 255, 0.3)";
                    document.querySelector.bind(document)('.music-control__progress-input').style.backgroundColor = "rgba(255, 255, 255, 0.3)";
                    ...
                    document.querySelector.bind(document)('.header').style.backgroundColor = `var(--header-color-${backgroundIndex})`;
                    document.querySelector.bind(document)('.header').style.boxShadow = '0 3px 5px rgba(0,0,0,0.1)';
                    document.querySelector.bind(document)('.main').style.backgroundImage = 'url(./assets/img/background-theme/backroundThemes/3.jpg)';
                    document.querySelector.bind(document)('.main-music-control').style.backgroundImage = 'none';
                    document.querySelector.bind(document)('.main-music-control').style.backgroundColor = '#D0CCC5';
                    document.querySelector.bind(document)('.mobile-tab').style.backgroundColor = '#D0CCC5';
                    document.querySelector.bind(document)('.sidebar__add-playlist').style.backgroundColor = '#DAD6D3';
                    document.querySelector.bind(document)('.sidebar__add-playlist').style.borderTop = '1px solid rgba(0, 0, 0, 0.1)';
                    document.querySelector.bind(document)('.nextsong__option-wrapper').style.backgroundColor = '#DAD6D3';
                    document.querySelector.bind(document)('.header__width-search-sub').style.backgroundColor = '#FFFFFE';
                    document.querySelector.bind(document)('.header__width-search-sub').classList.remove('header__width-search-sub--purple');
                    document.querySelector.bind(document)('.header__width-search-sub').classList.add('header__width-search-sub--white');
                    document.querySelector.bind(document)('.header__width-search-sub').classList.remove('header__width-search-sub--green');
                    document.querySelector.bind(document)('.header__width-search-sub').classList.remove('header__width-search-sub--gray');
                    document.querySelector.bind(document)('.header__setting-list').style.backgroundColor = '#FFFFFE';
                    document.querySelector.bind(document)('.theme-modal__body').style.backgroundColor = '#E6E1DE';
                    document.querySelector.bind(document)('.nextsong__option-wrapper-listplay').style.backgroundColor = '#E5E2E0';
                    document.querySelector.bind(document)('.main-sidebar').style.backgroundColor = 'rgba(0, 0, 0, 0.05)';
                    document.querySelector.bind(document)('.header__width-search-input').classList.add('header__width-search-input--white');
                    document.querySelector.bind(document)('.header__width-search-input').classList.remove('header__width-search-input--dark');
                    document.querySelector.bind(document)('.music-control__volume-input').style.backgroundColor = "rgba(0, 0, 0, 0.3)";
                    document.querySelector.bind(document)('.music-control__progress-input').style.backgroundColor = "rgba(0, 0, 0, 0.3)";
                    ...
                    document.querySelector.bind(document)('.music__option-item.music__option-item--active').style.backgroundColor = "#E5E2E0";
                    document.querySelector.bind(document)('.music__option-item.music__option-item--active').style.color = "#000";
                } else if (index == 4) {
                    backgroundIndex = 4;
                    document.querySelector.bind(document)('.header').style.backgroundColor = `var(--header-color-${backgroundIndex})`;
                    document.querySelector.bind(document)('.header').style.boxShadow = '0 3px 5px rgba(0,0,0,0.1)';
                    document.querySelector.bind(document)('.main').style.backgroundImage = 'url(./assets/img/background-theme/backroundThemes/4.jpg)';
                    document.querySelector.bind(document)('.main-music-control').style.backgroundImage = 'none';
                    document.querySelector.bind(document)('.main-music-control').style.backgroundColor = '#B4D0D0';
                    document.querySelector.bind(document)('.mobile-tab').style.backgroundColor = '#B4D0D0';
                    document.querySelector.bind(document)('.sidebar__add-playlist').style.backgroundColor = '#C9E4E6';
                    document.querySelector.bind(document)('.sidebar__add-playlist').style.borderTop = '1px solid rgba(0, 0, 0, 0.1)';
                    document.querySelector.bind(document)('.nextsong__option-wrapper').style.backgroundColor = '#C9E4E6';
                    document.querySelector.bind(document)('.header__width-search-sub').style.backgroundColor = '#FFFFFE';
                    document.querySelector.bind(document)('.header__width-search-sub').classList.remove('header__width-search-sub--purple');
                    document.querySelector.bind(document)('.header__width-search-sub').classList.add('header__width-search-sub--white');
                    document.querySelector.bind(document)('.header__width-search-sub').classList.remove('header__width-search-sub--green');
                    ...
                    document.querySelector.bind(document)('.header__width-search').classList.remove('js__gray-backgroundColor');
                    document.querySelector.bind(document)('.header__setting-list').style.backgroundColor = '#FFFFFE';
                    document.querySelector.bind(document)('.theme-modal__body').style.backgroundColor = '#C9E4E6';
                    document.querySelector.bind(document)('.nextsong__option-wrapper-listplay').style.backgroundColor = '#D9ECEE';
                    document.querySelector.bind(document)('.main-sidebar').style.backgroundColor = 'rgba(255, 255, 255, 0.3)';
                    document.querySelector.bind(document)('.header__width-search-input').classList.add('header__width-search-input--white');
                    document.querySelector.bind(document)('.header__width-search-input').classList.remove('header__width-search-input--dark');
                    document.querySelector.bind(document)('.music-control__volume-input').style.backgroundColor = "rgba(0, 0, 0, 0.3)";
                    document.querySelector.bind(document)('.music-control__progress-input').style.backgroundColor = "rgba(0, 0, 0, 0.3)";
                    ...
                    document.querySelector.bind(document)('.music__option-item.music__option-item--active').style.backgroundColor = "#D9ECEE";
                    document.querySelector.bind(document)('.music__option-item.music__option-item--active').style.color = "#000";
                } else if (index == 5) {
                    backgroundIndex = 5;
                    document.querySelector.bind(document)('.header').style.backgroundColor = `var(--header-color-${backgroundIndex})`;
                    document.querySelector.bind(document)('.header').style.boxShadow = '0 3px 5px rgba(0,0,0,0.1)';
                    document.querySelector.bind(document)('.main').style.backgroundImage = 'url(./assets/img/background-theme/backroundThemes/5.jpg)';
                    document.querySelector.bind(document)('.main-music-control').style.backgroundImage = 'none';
                    document.querySelector.bind(document)('.main-music-control').style.backgroundColor = '#F9C6C5';
                    document.querySelector.bind(document)('.mobile-tab').style.backgroundColor = '#F9C6C5';
                    document.querySelector.bind(document)('.sidebar__add-playlist').style.backgroundColor = '#F6E7E4';
                    document.querySelector.bind(document)('.sidebar__add-playlist').style.borderTop = '1px solid rgba(0, 0, 0, 0.1)';
                    document.querySelector.bind(document)('.nextsong__option-wrapper').style.backgroundColor = '#E6D2CD';
                    document.querySelector.bind(document)('.header__width-search-sub').style.backgroundColor = '#FFFFFE';
                    document.querySelector.bind(document)('.header__width-search-sub').classList.remove('header__width-search-sub--purple');
                    document.querySelector.bind(document)('.header__width-search-sub').classList.add('header__width-search-sub--white');
                    document.querySelector.bind(document)('.header__width-search-sub').classList.remove('header__width-search-sub--green');
                    ...
                    document.querySelector.bind(document)('.header__width-search').classList.remove('js__gray-backgroundColor');
                    document.querySelector.bind(document)('.header__setting-list').style.backgroundColor = '#FFFFFE';
                    document.querySelector.bind(document)('.theme-modal__body').style.backgroundColor = '#F9C6C5';
                    document.querySelector.bind(document)('.nextsong__option-wrapper-listplay').style.backgroundColor = '#EEE0DC';
                    document.querySelector.bind(document)('.main-sidebar').style.backgroundColor = 'rgba(255, 255, 255, 0.3)';
                    document.querySelector.bind(document)('.header__width-search-input').classList.add('header__width-search-input--white');
                    document.querySelector.bind(document)('.header__width-search-input').classList.remove('header__width-search-input--dark');
                    document.querySelector.bind(document)('.music__option-item.music__option-item--active').style.backgroundColor = "#EEE0DC";
                    document.querySelector.bind(document)('.music__option-item.music__option-item--active').style.color = "#000";
                    document.querySelector.bind(document)('.music-control__volume-input').style.backgroundColor = "rgba(0, 0, 0, 0.3)";
                    document.querySelector.bind(document)('.music-control__progress-input').style.backgroundColor = "rgba(0, 0, 0, 0.3)";
                    ...
                    document.querySelector.bind(document)('.header').style.backgroundColor = `var(--header-color-${backgroundIndex})`;
                    document.querySelector.bind(document)('.header').style.boxShadow = '0 3px 5px rgba(0,0,0,0.1)';
                    document.querySelector.bind(document)('.main').style.backgroundImage = 'url(./assets/img/background-theme/backroundThemes/6.jpg)';
                    document.querySelector.bind(document)('.main-music-control').style.backgroundImage = 'none';
                    document.querySelector.bind(document)('.main-music-control').style.backgroundColor = '#C6C4D1';
                    document.querySelector.bind(document)('.mobile-tab').style.backgroundColor = '#C6C4D1';
                    document.querySelector.bind(document)('.sidebar__add-playlist').style.backgroundColor = '#B1B0BA';
                    document.querySelector.bind(document)('.sidebar__add-playlist').style.borderTop = '1px solid rgba(0, 0, 0, 0.1)';
                    document.querySelector.bind(document)('.nextsong__option-wrapper').style.backgroundColor = '#B1B0BA';
                    document.querySelector.bind(document)('.header__width-search-sub').style.backgroundColor = '#FFFFFE';
                    document.querySelector.bind(document)('.header__width-search-sub').classList.remove('header__width-search-sub--purple');
                    document.querySelector.bind(document)('.header__width-search-sub').classList.add('header__width-search-sub--white');
                    document.querySelector.bind(document)('.header__width-search-sub').classList.remove('header__width-search-sub--green');
                    ...
                    document.querySelector.bind(document)('.header__width-search').classList.remove('js__gray-backgroundColor');
                    document.querySelector.bind(document)('.header__setting-list').style.backgroundColor = '#FFFFFE';
                    document.querySelector.bind(document)('.theme-modal__body').style.backgroundColor = '#E2E7F5';
                    document.querySelector.bind(document)('.nextsong__option-wrapper-listplay').style.backgroundColor = '#C9C8CF';
                    document.querySelector.bind(document)('.main-sidebar').style.backgroundColor = 'rgba(0,0,0,0.05)';
                    document.querySelector.bind(document)('.header__width-search-input').classList.add('header__width-search-input--white');
                    document.querySelector.bind(document)('.header__width-search-input').classList.remove('header__width-search-input--dark');
                    document.querySelector.bind(document)('.music__option-item.music__option-item--active').style.backgroundColor = "#C9C8CF";
                    document.querySelector.bind(document)('.music__option-item.music__option-item--active').style.color = "#000";
                    document.querySelector.bind(document)('.music-control__volume-input').style.backgroundColor = "rgba(0, 0, 0, 0.3)";
                    document.querySelector.bind(document)('.music-control__progress-input').style.backgroundColor = "rgba(0, 0, 0, 0.3)";
                    ...
                    document.querySelector.bind(document)('.header').style.backgroundColor = `var(--header-color-${backgroundIndex})`;
                    document.querySelector.bind(document)('.header').style.boxShadow = '0 3px 5px rgba(0,0,0,0.1)';
                    document.querySelector.bind(document)('.main').style.backgroundImage = 'url(./assets/img/background-theme/backroundThemes/7.jpg)';
                    document.querySelector.bind(document)('.main-music-control').style.backgroundImage = 'none';
                    document.querySelector.bind(document)('.main-music-control').style.backgroundColor = '#FFFFFF';
                    document.querySelector.bind(document)('.mobile-tab').style.backgroundColor = '#FFFFFF';
                    document.querySelector.bind(document)('.sidebar__add-playlist').style.backgroundColor = '#F2F2F2';
                    document.querySelector.bind(document)('.sidebar__add-playlist').style.borderTop = '1px solid rgba(0, 0, 0, 0.1)';
                    document.querySelector.bind(document)('.nextsong__option-wrapper').style.backgroundColor = '#F2F2F2';
                    document.querySelector.bind(document)('.header__width-search-sub').style.backgroundColor = '#FFFFFE';
                    document.querySelector.bind(document)('.header__width-search-sub').classList.remove('header__width-search-sub--purple');
                    document.querySelector.bind(document)('.header__width-search-sub').classList.add('header__width-search-sub--white');
                    document.querySelector.bind(document)('.header__width-search-sub').classList.remove('header__width-search-sub--green');
                    ...
                    document.querySelector.bind(document)('.header__setting-list').style.backgroundColor = '#FFFFFE';
                    document.querySelector.bind(document)('.theme-modal__body').style.backgroundColor = '#E6E1DE';
                    document.querySelector.bind(document)('.nextsong__option-wrapper-listplay').style.backgroundColor = '#FFFFFF';
                    document.querySelector.bind(document)('.main-sidebar').style.backgroundColor = 'rgba(0,0,0,0.05)';
                    document.querySelector.bind(document)('.header__width-search-input').classList.add('header__width-search-input--white');
                    document.querySelector.bind(document)('.header__width-search-input').classList.remove('header__width-search-input--dark');
                    document.querySelector.bind(document)('.music__option-item.music__option-item--active').style.backgroundColor = "#FFFFFF";
                    document.querySelector.bind(document)('.music__option-item.music__option-item--active').style.color = "#000";
                    document.querySelector.bind(document)('.music-control__volume-input').style.backgroundColor = "rgba(0, 0, 0, 0.3)";
                    document.querySelector.bind(document)('.music-control__progress-input').style.backgroundColor = "rgba(0, 0, 0, 0.3)";
    ...
    renderZingChart : function () {
        ...
        document.querySelector.bind(document)('.js__zingchart__list').innerHTML = htmls.join('');
    },
        ...
        const htmls = this.songsData.map((song, index) => {
            ...
            <div class="nextsong__fist-item nextsong__item ${audio.onplay && index == this.currentIndex ? 'nextsong__fist-item-headding--active' : ''} ${index == this.currentIndex ? 'nextsong__fist-item-background--active' : ''}" data-index="${index}">
                ...
                <div class="nextsong__item-body">
                    <span class="nextsong__item-body-heading document.querySelector.bind(document){index == this.currentIndex ? '' : 'js__main-color'}">${song.name}</span>
                    <span class="nextsong__item-body-depsc document.querySelector.bind(document){index == this.currentIndex ? '' : 'js__sub-color'}">${song.singer}</span>
                </div>
    ...
    renderNextSongHeaddingStart: function(playListElement, songs){
        const htmls = this.songsData.map((song, index) => {
            return index <= this.currentIndex ? `
            <!-- nextsong__fist-item-headding--active nextsong__fist-item-playbtn--active-->
            <div class="nextsong__fist-item nextsong__item nextsong__fist-item-playbtn--active ${audio.onplay && index == this.currentIndex ? 'nextsong__fist-item-headding--active' : ''} ${index == this.currentIndex ? 'nextsong__fist-item-background--active' : ''}" data-index="$(document){index}">
                <div class="nextsong__item-img" style="background-image: url(${song.background});">
                    <div class="nextsong__item-playbtn"><i class="fas fa-play"></i></div>
                    <div class="songs-item-left-img-playing-box">
                        <img class = "songs-item-left-img-playing" src="./assets/img/songs/icon-playing.gif" alt="playing">
    ...
    scrollToActiveSong: function () {
        setTimeout(() => {
          document.querySelector.bind(document)(".songs-item--active").scrollIntoView({
            behavior: "smooth",
            block: "nearest"
          });
        }, 300);
    ...
    scrollToActiveNextSong: function () {
        // setTimeout(() => {
        //   document.querySelector.bind(document)(".nextsong__fist-item-headding--active").scrollIntoView({
        //     behavior: "smooth",
        //     block: "nearest"
        //   });
        // }, 300);
    ...
    loadCurrentSong: function () {
        ...
        document.querySelector.bind(document)('.mobile-player__body-now-name').textContent = this.currentSong.name;
        nameSinger.textContent = this.currentSong.singer;
        document.querySelector.bind(document)('.mobile-player__body-now-singer').textContent = this.currentSong.singer;
        document.querySelector.bind(document)('.mobile-player__body-thumb').style.backgroundImage = `url('${this.currentSong.background}')`;
        document.querySelector.bind(document)('.music-control__left-img').style.backgroundImage = `url('${this.currentSong.background}')`;
    ...
    displayRemainTime : function() {
        ...
        // on mobile
        document.querySelector.bind(document)('.mobile-player__ctrl-progress-time-start').textContent = this.formatTime(audio.currentTime);
    },
    ...
    displayDurationTime : function() {
        ...
        document.querySelector.bind(document)('.mobile-player__ctrl-progress-time-duration').textContent = this.currentSong.duration;
    },
    ...
    verifyOptionTextColor: function() {
        document.querySelectorAll.bind(document)('.music__option-item').forEach((tab, index) => {
    ...
    handleEvents: function () {
        const _this = this;
        const songTyms = document.querySelectorAll.bind(document)('.songs-item-right-tym');
        const songItems = document.querySelectorAll.bind(document)('.js__song-item0');
        const nextSongsItem = document.querySelectorAll.bind(document)('.nextsong__item');
        const playBtnIcons = document.querySelectorAll.bind(document)('.js__songs-item-left-img-0');
        const playNextSongBtnIcons = document.querySelectorAll.bind(document)('.nextsong__item-img');
        const songItemsOption1 = document.querySelectorAll.bind(document)('.js__song-item1');
        const playBtnIconsOption1 = document.querySelectorAll.bind(document)('.js__songs-item-left-img-1');
        const actionHeartNextSongs = document.querySelectorAll.bind(document)('.nextsong__item-action-heart');
        const nextSongBox = document.querySelector.bind(document)('.nextsong__box');
        ...
        document.querySelector.bind(document)('.music-control__left').onclick = function() {
            document.querySelector.bind(document)('.mobile-player').classList.add('active');
        }

        document.querySelector.bind(document)('.mobile-player__headding-close').onclick = function() {
            document.querySelector.bind(document)('.mobile-player').classList.remove('active');
        }

        // NHẤN MORE HIỂN THỊ 100 BÀI HÁT
        document.querySelector.bind(document)('.js__zingchart__100more').onclick = function() {
        ...
        sideBarTabs.forEach((tab, index) => {
            tab.onclick = function() {
                document.querySelector.bind(document)('.js__sidebar-tabs.sidebar__item--active').classList.remove('sidebar__item--active');
        ...
        document.querySelectorAll.bind(document)('.js__mobile-tab__item').forEach((tab, index) => {
            tab.onclick = function() {
                document.querySelector.bind(document)('.mobile-tab__item.active').classList.remove('active');
        ...
        tabs.forEach((tab, index) => {
            ...
            document.querySelector.bind(document)('.panes-item:not(.music__option-item--active)').style.backgroundColor = 'transparent';
            themeItems[backgroundIndex].click();
            _this.verifyOptionTextColor();
            tab.onclick = function() {
                document.querySelector.bind(document)('.music__option-item.music__option-item--active').classList.remove('music__option-item--active');
                tab.classList.add('music__option-item--active')
                document.querySelector.bind(document)('.panes-item.active').classList.remove('active');
                ...
                // if (index === 1) {
                //     _this.renderPlayList1(document.querySelector.bind(document)('.option-music-list'),_this.songsData);
                // }
                document.querySelector.bind(document)('.music__option-item.music__option-item--active').classList.remove('js__main-color');
            }
        })
        ...
        const cdThumbAnimateMobile = document.querySelector.bind(document)('.mobile-player__body-thumb').animate([{ transform: "rotate(360deg)" }], {
            duration: 10000, // 10 seconds
            iterations: Infinity
        });
        ...
        document.querySelector.bind(document)('.js__container-discover__slider-right').onclick = function() {
            changeImage1();
        }
        // khi bấm vào nut left của slider
        document.querySelector.bind(document)('.js__container-discover__slider-left').onclick = function() {
            changeImage1Replate();
            sliderIndex1--;
            if (sliderIndex1 < 0) {
                sliderIndex1 = 3;
        ...
        document.querySelector.bind(document)('.js__mobile-player__ctrl-icon').onclick = function () {
            if (_this.isPlaying) {
              audio.pause();
            } else {
              audio.play();
        ...
        audio.onplay = function () {
            const nextSongsItemHeadding = document.querySelectorAll.bind(document)('.nextsong__fist-item');
            ...
            document.querySelector.bind(document)('.js__mobile-player__ctrl-icon').classList.add('music-control__icon-play--active');
            ...
            const nextSongItems = document.querySelectorAll.bind(document)('.nextsong__item')
        ...
        audio.onpause = function () {
            ...
            document.querySelector.bind(document)('.js__mobile-player__ctrl-icon').classList.remove('music-control__icon-play--active');
        ...
        audio.ontimeupdate = function () {
            if (audio.duration) {
                ...
                // on mobile
                document.querySelector.bind(document)('#progress2').value = progressPercent;
            }
        ...
        document.querySelector.bind(document)('#progress2').onchange = function (e) {
            const seekTime = (audio.duration / 100) * e.target.value;
            audio.currentTime = seekTime;
        }
        ...
        document.querySelector.bind(document)('.js__mobile-player__ctrl-icon4').onclick = function() {
            if (_this.isRandom) {
                _this.RandomSong();
                // không render list next song
                _this.renderNextSongHeadding(nextSongHeadding,this.songsData);
        ...
        document.querySelector.bind(document)('.js__mobile-player__ctrl-icon2').onclick = function() {
            if (_this.isRandom) {
                _this.RandomSong();
                // không render list next song
                _this.renderNextSongHeadding(nextSongHeadding,this.songsData);
        ...
        playBtnIcons.forEach((playBtnIcon, index) => {
            playBtnIcon.onclick = function() {
                ...
                if(_this.isRandom) {
                    ...
                    document.querySelector.bind(document)('.nextsong__last-item-end').textContent = 'HẾT BÀI RỒI BẠN ƠI! HAHA';
                } else {
                    _this.renderNexrSong();
                    _this.scrollToActiveNextSong();
                }
        ...
        document.querySelector.bind(document)('.js__mobile-player__ctrl-icon1').onclick = function() {
            _this.isRandom = !_this.isRandom;
            _this.isRepeat = false;
            randomBtn.classList.toggle("music-control__icon-random--active", _this.isRandom);
            document.querySelector.bind(document)('.js__mobile-player__ctrl-icon1').classList.toggle("music-control__icon-random--active", _this.isRandom);
            if (_this.isRandom) {
                randomBtn.style.color = 'var(--primary-color)';
            } else {
                randomBtn.style.color = '#fff';
            }
            document.querySelector.bind(document)('.js__mobile-player__ctrl-icon5').classList.toggle("music-control__icon-repeat--active", _this.isRepeat);
        ...
        document.querySelector.bind(document)('.js__mobile-player__ctrl-icon5').onclick = function() {
            _this.isRepeat = !_this.isRepeat;
            _this.isRandom = false;
            // _this.setConfig("isRepeat", _this.isRepeat);
            document.querySelector.bind(document)('.js__mobile-player__ctrl-icon5').classList.toggle("music-control__icon-repeat--active", _this.isRepeat);
            // document.querySelector.bind(document)('.js__mobile-player__ctrl-icon5').style.color = 'var(--primary-color)';
            document.querySelector.bind(document)('.js__mobile-player__ctrl-icon1').classList.toggle("music-control__icon-random--active", _this.isRandom);
            _this.renderNexrSong();
            _this.scrollToActiveNextSong();
        }
        ...
        loginbtn.onclick = function() {
            loginModal.classList.toggle('login-modal--avtive');
        }
        loginBody.onclick = function(e) {
            e.stopPropagation();
        }
        loginClosebtn.onclick = function() {
            loginModal.classList.remove('login-modal--avtive');
        }
        loginOverlay.onclick = function() {
            loginModal.classList.remove('login-modal--avtive');
        }
        ...
        registerbtn.onclick = function() {
            registerModal.classList.toggle('register-modal--avtive');
        }
        registerBody.onclick = function(e) {
            e.stopPropagation();
        }
    ...
    start: function() {
        ...
        this.renderPlayList1(document.querySelector.bind(document)('.option-music-list'),this.songsData);
        // render next song
        this.renderNexrSong();
